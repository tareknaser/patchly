...
4. Choose The Next Step (hover menu):

   1. Fix: Apply a suggested fix directly in your code
   2. Explain: A guided learning chat to learn more about the vulnerability
